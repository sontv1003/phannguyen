...
class ControllerProductLookbook extends Controller {
    ...
    public function index() {
        $this->language->load('product/lookbbok');
        ...
        if ($categories) {
            ...
            foreach ($categories as $category) {
                $category_info = array(
                    'name' => $category['name'],
                    'thumb' => $this->model_tool_image->resize($category_info['image'], $this->config->get('config_image_category_width'), $this->config->get('config_image_category_height')),
                    'href' => $this->url->link('product/lookbok_category', 'lookpath=' . $category['category_id'])
                );
