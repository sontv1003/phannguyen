    ...
    public function index() {
        ...
        if ($product_info) {
            ...
            if ($product_info['image']) {
                $this->data['popup'] = $this->model_tool_image->resize($product_info['image'], 2000, 3000);
            } else {
                $this->data['popup'] = '';
            }
            ...
            foreach ($results as $result) {
                $this->data['images'][] = array(
                    'popup' => $this->model_tool_image->resize($result['image'], 2000, 3000/*$this->config->get('config_image_popup_width'), $this->config->get('config_image_popup_height')*/),
            ...
            foreach ($results as $result) {
                ...
                $manufacturerRelated = $this->model_catalog_manufacturer->getManufacturer($result['manufacturer_id']);
                $this->data['products'][] = array(
                    ...
                    'special' => $special,
                    'rating' => $rating,
                    'manufacturer_name' => !empty($manufacturerRelated['name']) ? $manufacturerRelated['name'] : '',
