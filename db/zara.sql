...
INSERT INTO `setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES
	...
	(5071, 0, 'config', 'config_error_log', '1', 0),
	(5070, 0, 'config', 'config_error_display', '1', 0),
	(5069, 0, 'config', 'config_compression', '0', 0),
	(5068, 0, 'config', 'config_encryption', '7f339d82bc9ee711ed084c4a101fbb25', 0),
	(5066, 0, 'config', 'config_maintenance', '0', 0),
	(5067, 0, 'config', 'config_password', '0', 0),
	(5065, 0, 'config', 'config_file_mime_allowed', '', 0),
	(5064, 0, 'config', 'config_file_extension_allowed', '', 0),
	(5062, 0, 'config', 'config_robots', '', 0),
	(5063, 0, 'config', 'config_seo_url', '1', 0),
	(5061, 0, 'config', 'config_shared', '0', 0),
	(5060, 0, 'config', 'config_secure', '0', 0),
	(5059, 0, 'config', 'config_fraud_status_id', '7', 0),
	(5058, 0, 'config', 'config_fraud_score', '', 0),
	(5057, 0, 'config', 'config_fraud_key', '', 0),
	(5056, 0, 'config', 'config_fraud_detection', '0', 0),
	(5055, 0, 'config', 'config_alert_emails', '', 0),
	(5054, 0, 'config', 'config_account_mail', '0', 0),
	(5053, 0, 'config', 'config_alert_mail', '0', 0),
	(5052, 0, 'config', 'config_smtp_timeout', '5', 0),
	(5051, 0, 'config', 'config_smtp_port', '25', 0),
	(5050, 0, 'config', 'config_smtp_password', '', 0),
	(5049, 0, 'config', 'config_smtp_username', '', 0),
	(5048, 0, 'config', 'config_smtp_host', '', 0),
	(5047, 0, 'config', 'config_mail_parameter', '', 0),
	(5046, 0, 'config', 'config_mail_protocol', 'mail', 0),
	(5045, 0, 'config', 'config_ftp_status', '0', 0),
	(5044, 0, 'config', 'config_ftp_root', '', 0),
	(5043, 0, 'config', 'config_ftp_password', '', 0),
	(5042, 0, 'config', 'config_ftp_username', '', 0),
	(5041, 0, 'config', 'config_ftp_port', '21', 0),
	(5040, 0, 'config', 'config_ftp_host', 'ishopts.com', 0),
	(5039, 0, 'config', 'config_image_cart_height', '175', 0),
	(5038, 0, 'config', 'config_image_cart_width', '135', 0),
	(5037, 0, 'config', 'config_image_wishlist_height', '47', 0),
	(5036, 0, 'config', 'config_image_wishlist_width', '47', 0),
	(5035, 0, 'config', 'config_image_compare_height', '90', 0),
	(5034, 0, 'config', 'config_image_compare_width', '90', 0),
	(5033, 0, 'config', 'config_image_related_height', '35', 0),
	(5032, 0, 'config', 'config_image_related_width', '35', 0),
	(5031, 0, 'config', 'config_image_additional_height', '150', 0),
	(5030, 0, 'config', 'config_image_additional_width', '150', 0),
	(5029, 0, 'config', 'config_image_product_height', '640', 0),
	(5028, 0, 'config', 'config_image_product_width', '400', 0),
	(5027, 0, 'config', 'config_image_popup_height', '600', 0),
	(5026, 0, 'config', 'config_image_popup_width', '400', 0),
	(5025, 0, 'config', 'config_image_thumb_height', '228', 0),
	(5023, 0, 'config', 'config_image_news_height', '', 0),
	(5024, 0, 'config', 'config_image_thumb_width', '228', 0),
	(5022, 0, 'config', 'config_image_news_width', '', 0),
	(5021, 0, 'config', 'config_image_category_height', '80', 0),
	(5020, 0, 'config', 'config_image_category_width', '80', 0),
	(5019, 0, 'config', 'config_home_image', 'data/WOMAN_en.jpg', 0),
	(5018, 0, 'config', 'config_icon', 'data/cart.png', 0),
	(5017, 0, 'config', 'config_logo', 'data/logo_Zara.png', 0),
	(5015, 0, 'config', 'config_return_id', '0', 0),
	(5016, 0, 'config', 'config_return_status_id', '2', 0),
	...
	(5006, 0, 'config', 'config_invoice_prefix', 'INV-2013-00', 0),
	(5005, 0, 'config', 'config_order_edit', '100', 0),
	(5004, 0, 'config', 'config_checkout_id', '3', 0),
	(5003, 0, 'config', 'config_guest_checkout', '1', 0),
	(5002, 0, 'config', 'config_cart_weight', '1', 0),
	(5001, 0, 'config', 'config_account_id', '5', 0),
	...
	(4990, 0, 'config', 'config_download', '1', 0),
	(4989, 0, 'config', 'config_review_status', '1', 0),
	(4988, 0, 'config', 'config_product_count', '1', 0),
	(4987, 0, 'config', 'config_admin_limit', '20', 0),
	(4986, 0, 'config', 'config_catalog_limit', '15', 0),
	(4985, 0, 'config', 'config_weight_class_id', '1', 0),
	(4984, 0, 'config', 'config_length_class_id', '1', 0),
	(4983, 0, 'config', 'config_currency_auto', '1', 0),
	(4982, 0, 'config', 'config_currency', 'USD', 0),
	(4981, 0, 'config', 'config_admin_language', 'vi', 0),
	(4980, 0, 'config', 'config_language', 'vi', 0),
	(4979, 0, 'config', 'config_zone_id', '3776', 0),
	(4978, 0, 'config', 'config_country_id', '230', 0),
	(4977, 0, 'config', 'config_layout_id', '4', 0),
	(4976, 0, 'config', 'config_template', 'default', 0),
	(4975, 0, 'config', 'config_meta_description', 'Thơi trang công sở nam - thời trang phan nguyễn', 0),
	(4974, 0, 'config', 'config_title', 'Thời Trang Phan Nguyễn', 0),
	(4973, 0, 'config', 'config_fax', '', 0),
	(4972, 0, 'config', 'config_telephone', '0936474346', 0),
	(4971, 0, 'config', 'config_email', 'phannguyen@admin.com', 0),
	(4970, 0, 'config', 'config_address', '98 Đội Cấn - Ba Đình - Hà Nội', 0),
	(4969, 0, 'config', 'config_owner', 'Thời Trang Phan Nguyễn', 0),
	(4754, 0, 'free', 'free_status', '1', 0),
	(4755, 0, 'free', 'free_sort_order', '', 0),
	(4968, 0, 'config', 'config_name', 'Thời Trang Phan Nguyễn', 0),
	(5072, 0, 'config', 'config_error_filename', 'error.txt', 0),
	(5073, 0, 'config', 'config_google_analytics', '', 0);
