...
$_['entry_product_count']          = 'Đếm sản phẩm trên danh mục:<br /><span class="help">Hiển thị số lượng sản phẩm trong các tiểu thể loại trong các cửa hàng đơn thể loại tiêu đề. Được cảnh báo, điều này sẽ gây ra một đạt hiệu suất cực cho các cửa hàng với rất nhiều tiểu thể loại!</span>';
$_['entry_review']       	       = 'Allow Reviews:<br /><span class="help">Enable/Disable new review entry and display of existing reviews</span>';
$_['entry_download']               = 'Cho phép Downloads:';
$_['entry_upload_allowed']         = 'Cho phép tải File Extensions:<br /><span class="help">Add which file extensions are allowed to be uploaded. Use comma separated values.</span>';
$_['entry_voucher_min']            = 'Voucher nhỏ nhất:<br /><span class="help">Minimum amount a customer can purchase a voucher for.</span>';
$_['entry_voucher_max']            = 'Voucher lớn nhất:<br /><span class="help">Maximum amount a customer can purchase a voucher for.</span>';
$_['entry_tax']               = 'Hiện thị giá và thuế:';
$_['entry_vat']                    = 'Thuế giá trị gia tăng';
$_['entry_tax_default']        = 'Địa chỉ thuế';
$_['entry_tax_customer']       = 'Địa chỉ thuế khách hàng';
$_['entry_customer_online']        = 'Khách hàng Online:<br /><span class="help">Theo dõi khách hàng trực tuyến thông qua các phần báo cáo khách hàng.</span>';
$_['entry_customer_group']         = 'Nhóm khách hàng:<br /><span class="help">Mặc định nhóm khách hàng.</span>';
$_['entry_customer_group_display'] = 'Các nhóm khách hàng:<br /><span class="help">Hiển thị các nhóm khách hàng mà khách hàng mới có thể chọn để sử dụng như bán buôn và kinh doanh khi đăng ký.</span>';
