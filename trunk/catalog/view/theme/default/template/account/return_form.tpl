                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="content">
                        <div class="left"><span class="required">*</span> <?php echo $entry_firstname; ?><br />
                            <input class="inputText" type="text" name="firstname" value="<?php echo $firstname; ?>" class="large-field" />
                            <br />
                            ...
                            <input class="inputText" type="text" name="lastname" value="<?php echo $lastname; ?>" class="large-field" />
                            <br />
                            ...
                            <input class="inputText" type="text" name="email" value="<?php echo $email; ?>" class="large-field" />
                            <br />
                            <?php if ($error_email) { ?>
                            ...
                            <input class="inputText" type="text" name="telephone" value="<?php echo $telephone; ?>" class="large-field" />
                            <br />
                        ...
                        <div class="right"><span class="required">*</span> <?php echo $entry_order_id; ?><br />
                            <input class="inputText" type="text" name="order_id" value="<?php echo $order_id; ?>" class="large-field" />
                            <br />
                            ...
                            <input class="inputText date" type="text" name="date_ordered" value="<?php echo $date_ordered; ?>" class="large-field " />
                            <br />
                        </div>
                    </div>
                        ...
                        <div class="content">
                            <div class="return-product">
                                <div class="return-name"><span class="required">*</span> <b><?php echo $entry_product; ?></b><br />
                                    <input class="inputText" type="text" name="product" value="<?php echo $product; ?>" />
                                    <br />
                                ...
                                <div class="return-model"><span class="required">*</span> <b><?php echo $entry_model; ?></b><br />
                                    <input class="inputText" type="text" name="model" value="<?php echo $model; ?>" />
                                    <br />
                                    <?php if ($error_model) { ?>
                                ...
                                <div class="return-quantity"><b><?php echo $entry_quantity; ?></b><br />
                                    <input class="inputText" type="text" name="quantity" value="<?php echo $quantity; ?>" />
                                </div>
                            </div>
                            <div class="return-detail">
                                ...
                                <div class="return-captcha"><b><?php echo $entry_captcha; ?></b><br />
                                    <input class="inputText" type="text" name="captcha" value="<?php echo $captcha; ?>" />
                                    <br />
                    ...
                    <?php if ($text_agree) { ?>
                        <div class="buttons">
                            ...
                            <div class="right"><?php echo $text_agree; ?>
                                ...
                                <?php } ?>
                                <input class="inputText" type="submit" value="<?php echo $button_continue; ?>" class="button" />
                            </div>
                        </div>
                    <?php } else { ?>
                        <div class="buttons">
